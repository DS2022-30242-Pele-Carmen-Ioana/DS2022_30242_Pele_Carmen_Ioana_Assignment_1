...
public class DeviceController {
    ...
    @PutMapping("/{idDevice}/{idMeasurement}")
    public ResponseEntity<?> addMeasurement(@PathVariable UUID idDevice, @PathVariable UUID idMeasurement){
        List<MeasurementsDTO> measurements=deviceService.addMeasurement(idDevice,idMeasurement);
